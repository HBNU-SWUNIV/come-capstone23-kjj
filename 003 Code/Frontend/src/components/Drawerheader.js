  ...
  const onChangeMarketInfo = () => {
    ...
    return(
          ...
          >
            ...
            onClick={handleClick}>
              ...
              alignItems:'center'
                ...
                <span style={{marginLeft:'5vw', fontSize:'20px', fontWeight:'500', color:'inherit'}}>관리자</span>
                <div style={{
                  display:'flex',justifyContent:'flex-end',alignItems:'center',
                  width:'20vw', height:'3vh',marginLeft:'-7vw'
                }}>
                    <span style={{fontSize:'18px', fontWeight:'600', color:'inherit',textDecoration:'underline',textDecorationThickness:'2px', whiteSpace:'nowrap',textAlign:'right'}}>한밭대학교 구내식당</span>
                    <span style={{fontSize:'15px',color:'inherit',marginLeft:'3px',marginTop:'2px'}}>님</span>
                </div>
            </div> 
            </IconButton>
          </Toolbar>
        ...
        <Drawer variant="permanent" open={open1}>
          ...
          <List component="nav">
            <div style={{
              width:'15vw',height:'20vh',display:'flex',
