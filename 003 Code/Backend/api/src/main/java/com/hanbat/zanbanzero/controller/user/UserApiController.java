...
public class UserApiController {
    ...
    @PatchMapping("/api/users/{id}/policy/date")
    ...
    @PatchMapping("/api/users/{user_id}/policy/menu/{menu_id}")
    ...
    @GetMapping("/api/users/{id}/policy/date")
