...
public class ManagerApiController {
    ...
    public ResponseEntity<ManagerInfoDto> getInfo() throws JwtException {
    ...
    public ResponseEntity<String> setManagerNickname(@RequestBody ManagerInfoDto dto) {
    ...
    public ResponseEntity<String> setManagerPassword(@RequestBody ManagerPasswordDto dto) throws JwtException {
