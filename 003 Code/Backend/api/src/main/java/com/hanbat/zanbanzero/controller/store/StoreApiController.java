...
public class StoreApiController {
    ...
    @GetMapping("/api/manager/setting")
    ...
    @PostMapping("/api/manager/setting")
    ...
    @GetMapping("/api/manager/state/today")
    ...
    @GetMapping("/api/manager/state/last-week/user")
    ...
    @GetMapping("/api/manager/state/menu")
    ...
    @PostMapping("/api/manager/store/off/{year}/{month}/{day}")
    ...
    @GetMapping("/api/manager/store/off/{year}/{month}")
